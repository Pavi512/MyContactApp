...
public class ManageTags {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Contact c1 = new Contact("Pavi");
            Contact c2 = new Contact("Hari");

            // EnumSet for predefined tags

            EnumSet<DefaultTag> defaultTags = EnumSet.allOf(DefaultTag.class);
            ...
            while (true) {
                ...
                System.out.println("2. Assign Tag to Pavi");

                System.out.println("3. Assign Tag to Hari");
