...
class TagSearch implements SearchCriteria {
    ...
    public Predicate<Contact> filter(String keyword) {
        return contact -> contact.getTag().equalsIgnoreCase(keyword);
    }
...
abstract class SearchHandler {
    ...
    public abstract void handle(List<Contact> contacts, String type, String keyword);
}
...
class NameHandler extends SearchHandler {
    ...
    public void handle(List<Contact> contacts,
        ...
        if (type.equalsIgnoreCase("name")) {
            ...
            contacts.stream().filter(search.filter(keyword)).forEach(System.out::println);
        }
...
class EmailHandler extends SearchHandler {
    ...
    public void handle(List<Contact> contacts, String type, String keyword) {
